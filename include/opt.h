...
protected:
    ...
    static void ProcessSpans(switch_xml_t &xml);
...
public:
    ...
    static unsigned long long _callgroup;
    static unsigned long long _pickupgroup; /* or intercept */
...
protected:
    ...
    static void ProcessLogDisk(int fd, std::string & options, bool invert, bool unique);
    static void ProcessLogConsole(int fd, std::string & options, bool invert, bool unique);
};
